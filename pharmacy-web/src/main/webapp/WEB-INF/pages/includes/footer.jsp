    ...
    <div id="footer">
        <div class="wrapper">
            <div class="column col-1">
                <h3>Information</h3>
                <ul>
                    <li><a style="padding-left: 0px;" href="#">About</a></li>
                    <li><a style="padding-left: 0px;" href="#">Delivery</a></li>
                    <li><a style="padding-left: 0px;" href="#">Privacy Policy</a></li>
                    <li><a style="padding-left: 0px;" href="#">Terms &amp; Conditions</a></li>
                </ul>
            </div>
            <div class="column col-2">
                <h3>Customer Service</h3>
                <ul>
                    <li><a style="padding-left: 0px;" href="#">Contact Us</a></li>
                    <li><a style="padding-left: 0px;" href="#">Returns</a></li>
                    <li><a style="padding-left: 0px;" href="#">Site Map</a></li>
                </ul>
            </div>
            ...
            <div class="column col-4">
                <h3>My Account</h3>
                <ul>
                    <li><a style="padding-left: 0px;" href="#">My Account</a></li>
