			...
			return this.each(function() {
				...
				if (opt.mouseWheel=="on") {
					top_container.bind('mousewheel', function(event, delta) {
						...
						if (delta<0)
							top.data('mw',setTimeout(function() {rightClick(top_container,opt);},100));
						 else
							 top.data('mw',setTimeout(function() {leftClick(top_container,opt);},100));
													...
													if ($this.position().left<0) {
														$this.animate({'left':overslide+"px"},{duration:0,queue:false});
															...
															setTimeout(function() {
																...
																$this.animate({'left':opt.positionArray[$this.data('id')]+"px"},{duration:300,queue:false});
																},0);//+$this.data('id')*10);
													}
												}
											} else {
